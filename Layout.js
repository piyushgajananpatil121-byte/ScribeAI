...
import { PenTool, History, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
        ...
        <Sidebar className="border-r border-slate-200/60 backdrop-blur-xl bg-white/80">
          <SidebarHeader className="border-b border-slate-200/60 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 text-lg">FucD54</h2>
                <p className="text-xs text-slate-500">Handwriting Generator</p>
              </div>
            </div>
          </SidebarHeader>
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-6 py-4 md:hidden">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-slate-900">FucD54</h1>
            </div>
          </header>
